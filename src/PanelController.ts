    ...
    private readonly CATEGORIES: PanelCategory[] = [
        {
            ...
            items: [
                ...
                {type: 'trigger', subtype: 'activity_created', icon: '📌', name: 'Activity Created', desc: 'New task / activity', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'lead_assigned', icon: '👤', name: 'Lead Assigned', desc: 'Lead assigned to manager', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'client_assigned', icon: '🏢', name: 'Client Assigned', desc: 'Client assigned to manager', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'deal_assigned', icon: '💼', name: 'Deal Assigned', desc: 'Deal assigned to manager', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'trial_expiring', icon: '⏰', name: 'Trial Expiring', desc: 'N days until trial ends', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'manager_leaving', icon: '🚪', name: 'Manager Leaving', desc: 'Leaving department', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'subscription_cancelled', icon: '❌', name: 'Subscription Cancelled', desc: 'Subscription cancelled', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'lead_wrote', icon: '💬', name: 'Lead Wrote', desc: 'Lead sent message', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'lead_messaged', icon: '📨', name: 'Lead Messaged', desc: 'Message sent to lead', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'deal_created', icon: '🤝', name: 'Deal Created', desc: 'New deal created', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'contact_created', icon: '👥', name: 'Contact Created', desc: 'New contact created', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'call_ended', icon: '📞', name: 'Call Ended', desc: 'Call completed', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'order_paid', icon: '💳', name: 'Order Paid', desc: 'Order payment received', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'deal_stage_changed', icon: '📊', name: 'Deal Stage Changed', desc: 'Stage moved in pipeline', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'client_status_stuck', icon: '🔒', name: 'Client Status Stuck', desc: 'Client stuck in status', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'touch_reminder', icon: '🔔', name: 'Touch Reminder', desc: 'No touch in N days', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'account_expiring', icon: '⚠️', name: 'Account Expiring', desc: 'Account expires soon', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'client_pipeline_change', icon: '🔄', name: 'Client Pipeline Change', desc: 'Moved to another pipeline', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'lead_unprocessed', icon: '⏳', name: 'Lead Unprocessed', desc: 'Lead not handled in time', bg: '#1e3a5f'},
                {type: 'trigger', subtype: 'activity_overdue', icon: '🚨', name: 'Activity Overdue', desc: 'Activity past due date', bg: '#1e3a5f'},
            ],
        },
        {
            ...
            items: [
                ...
                {type: 'action', subtype: 'get_managers', icon: '👥', name: 'Get Managers', desc: 'Managers + territory', bg: '#2d1e5f'},
                {type: 'action', subtype: 'create_activity', icon: '📌', name: 'Create Activity', desc: 'Task / activity', bg: '#2d1e5f'},
                {type: 'action', subtype: 'add_note', icon: '📝', name: 'Add Note', desc: 'Note to entity', bg: '#2d1e5f'},
                {type: 'action', subtype: 'deal_stage_move', icon: '📊', name: 'Deal Stage Move', desc: 'Move in pipeline', bg: '#2d1e5f'},
                {type: 'action', subtype: 'new_email_template', icon: '📄', name: 'New Email Template', desc: 'Create template', bg: '#2d1e5f'},
                {type: 'action', subtype: 'get_email_templates', icon: '📂', name: 'Get Email Templates', desc: 'Fetch templates', bg: '#2d1e5f'},
                {type: 'action', subtype: 'email_manager', icon: '📨', name: 'Email Manager', desc: 'Email to manager', bg: '#2d1e5f'},
                {type: 'action', subtype: 'email_client', icon: '📩', name: 'Email Client', desc: 'Email to client', bg: '#2d1e5f'},
                {type: 'action', subtype: 'web_hook', icon: '🔌', name: 'Web Hook', desc: 'Trigger webhook', bg: '#2d1e5f'},
                {type: 'action', subtype: 'reschedule_activities', icon: '📅', name: 'Reschedule Activities', desc: 'Move overdue', bg: '#2d1e5f'},
                {type: 'action', subtype: 'update_lead', icon: '👤', name: 'Update Lead', desc: 'Update lead fields', bg: '#2d1e5f'},
                {type: 'action', subtype: 'update_client', icon: '🏢', name: 'Update Client', desc: 'Update client fields', bg: '#2d1e5f'},
            ],
        },
        {
