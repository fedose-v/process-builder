...
class ThemeManager {
    private readonly MOON_ICON =
        '<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/>';
    private readonly SUN_ICON =
    ...
    apply(light: boolean): void {
        ...
        if (icon) icon.innerHTML = light ? this.MOON_ICON : this.SUN_ICON;
    }
    ...
    showConfirm(message: string, onConfirm: () => void, danger = false): void {
